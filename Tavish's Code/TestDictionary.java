...
public class TestDictionary {
  ...
  public void dictionaryInitTest() {
    try {
      ...
      String expectedOutput = "[load factor: black, cs: red, ssh: black, bash: black, "
          + "hash function: black, make: red, vim: red, binary search tree: red, "
          + "emacs: red, junit: red]";
  ...
  public void dictionaryAddTest() {
    try {
      ...
      try {
        ...
        // if expected output matches actual output, test pass otherwise fail.
        System.out.println(displayNodeAndColor(rbt));
        System.out.println(displayNodeAndColor(rbtInit));
