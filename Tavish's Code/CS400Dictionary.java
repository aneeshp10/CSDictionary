...
public class CS400Dictionary extends RedBlackTree<WordNode> {
  ...
  public CS400Dictionary() throws FileNotFoundException {
    ...
    loader = new LoadFile(new File("database.txt"));
  ...
  public void quizHelper() {
    ...
    // dictionary
    System.out
        .println("Press any key to start the quiz. If you want to return to main menu, press 'e'");
  ...
  /**
   * Recursive helper method to print variables in pre-order fashion to be used by quiz interface
   * 
  ...
  /**
   * Recursive helper method to print variables in in-order fashion to be used by quiz interface
   * 
   * @param node node of the tree from where we'll start traversing
   * 
   */
  ...
  /**
   * Recursive helper method to print variables in post-order fashion to be used by quiz interface
   * 
   * @param node node of the tree from where we'll start traversing
   * 
   */
  ...
  public void displayAllTermsHelper() {
    ...
    if (getAllTerms(rbt.root).isBlank()) {
      System.out
          .println("The dictionary is empty, please add terms using the 'Add a new term' feature.");
      return;
    }
    boolean input = true;
    while (input) {
  ...
  /**
   * Helper method that retusns the whole tree (converted to a String type) traversed in an inOrder
  ...
  private String getAllTerms(RedBlackTree.Node<WordNode> current) {
    ...
    // traverse through the tree in an inOrder fashion
      ...
      treeString += ("Word: " + current.data.getWord() + " (" + current.data.getModule() + ")\n"
          + "Definition: " + current.data.getDefinition() + "\n\n"); // print values
   ...
   * 
   * @throws NoSuchElementException when trying to get a definition of a term that doesn't exist
  ...
  public static void main(String[] args) throws FileNotFoundException {
    ...
    System.out.println(
        "***********************************************************************************\n"
            ...
            + "\n");
    System.out.println(
        "Welcome to this interactive CS400 dictionary, study tool made to help you learn terms\n"
